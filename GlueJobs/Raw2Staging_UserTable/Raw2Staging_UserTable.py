...
if __name__ == "__main__":
    ...
    user_table_fetcher = GlueDataFetcher("raw", "raw_user", "latest")
    user = user_table_fetcher.get_dataframe()
    
    # As done in Raw EDA, applying only required Data Standardization
    ...
    dest_s3_location = 's3://shivam-trial-s3/staging/user/'
    glue_table_manager = GlueTableManager('stage', 'stage_user', user_stg ,dest_s3_location)
