...
if __name__ == "__main__":
    ...
    retention_metrics = retention_metrics.withColumn('batch_id',lit(batch_id))
    dest_s3_location = 's3://shivam-trial-s3/mart/retention_metrics/'
    glue_table_manager = GlueTableManager('mart', 'mart_retention_metrics', retention_metrics ,dest_s3_location)
